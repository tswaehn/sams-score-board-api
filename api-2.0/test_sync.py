...
class HistoricalSyncTest(unittest.TestCase):
    def test_syncs_seasons_then_entities_by_season(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual({"seasons": 2, "competitions": 1, "leagues": 1, "teams": 1, "associations": 1, "match_groups": 1, "competition_matches": 1, "competition_match_results": 1, "competition_match_group_rankings": 0, "league_match_days": 1, "league_matches": 1, "league_match_results": 1, "league_rankings": 1, "internal_logs": 0}, database.status())
            self.assertEqual(
