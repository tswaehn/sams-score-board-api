...
class CompetitionListStore(PeriodicUpdater):
    def __init__(self) -> None:
        ...
        super().__init__(
            ...
            update_callback=self.update_competition_list,
        )
    ...
    def update_competition_list(self) -> None:
        seasons_payload = SEASON.updateAll()
...
def update_competition_list() -> None:
    COMPETITION_LIST_STORE.update_competition_list()
